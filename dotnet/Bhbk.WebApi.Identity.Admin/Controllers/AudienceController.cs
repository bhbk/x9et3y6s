...
namespace Bhbk.WebApi.Identity.Admin.Controllers
{
    ...
    public class AudienceController : BaseController
    {
        ...
        public IActionResult CreateV1([FromBody] AudienceV1 model)
        {
            ...
            var result = uow.Audiences.Post(map.Map<tbl_Audience>(model));
        ...
        public IActionResult GetV1([FromBody] PagerState state)
        {
            ...
            try
            {
                var result = new PagerStateResult<AudienceV1>
                {
        ...
        public IActionResult UpdateV1([FromBody] AudienceV1 model)
        {
            ...
            var entity = map.Map<tbl_Audience>(model);
            uow.Audiences.Put(entity);
            uow.Commit();

            return Ok(map.Map<AudienceV1>(entity));
        }
    }
}