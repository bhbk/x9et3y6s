...
namespace Bhbk.WebApi.Identity.User.Controllers
{
    ...
    public class CredentialsController : BaseController
    {
        ...
        [Route("v1/email/confirm/{userID:guid}"), HttpPut]
        ...
        [Route("v1/password/confirm/{userID:guid}"), HttpPut]
        ...
        [Route("v1/phone/confirm/{userID:guid}"), HttpPut]
