    ...
    public class AudienceServiceTests : IClassFixture<BaseAdminServiceTests>
    {
        ...
        public async Task Admin_AudienceV1_AddToRole_Success()
        {
            ...
            using (var scope = _factory.Server.Host.Services.CreateScope())
            {
                ...
                var testAudience = uow.Audiences.Get(x => x.Name == _factory.TestData.Audience.Name).Single();
                var testRole = uow.Roles.Post(
                    map.Map<tbl_Role>(new RoleV1()
                    {
                        AudienceId = audience.Id,
                        Name = Base64.CreateString(4) + "-" + _factory.TestData.Role.Name,
                        IsEnabled = true,
                        IsDeletable = false,
                    }));
        ...
        public async Task Admin_AudienceV1_RemoveFromRole_Success()
        {
            ...
            using (var scope = _factory.Server.Host.Services.CreateScope())
            {
                ...
                var testAudience = uow.Audiences.Get(x => x.Name == _factory.TestData.Audience.Name).Single();
                var testRole = uow.Roles.Get(x => x.Name == _factory.TestData.Role.Name).Single();
        ...
        public async Task Admin_AudienceV1_SetPassword_Success()
        {
            ...
            using (var scope = _factory.Server.Host.Services.CreateScope())
            {
                ...
                var testAudiencePassword = new PasswordAddV1()
                {
                    ...
                    NewPassword = _factory.TestData.Audience.PasswordNew,
                    NewPasswordConfirm = _factory.TestData.Audience.PasswordNew
                };
        ...
        public async Task Admin_AudienceV1_Update_Success()
        {
            ...
            using (var scope = _factory.Server.Host.Services.CreateScope())
            {
                ...
                var testAudience = uow.Audiences.GetAsNoTracking(x => x.Name == _factory.TestData.Audience.Name).Single();
