...
{
    public class BaseUserServiceTests : WebApplicationFactory<Bhbk.WebApi.Identity.User.Startup>
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            var env = new ContextService(InstanceContext.End2EndTest);
            ...
            builder.ConfigureServices(sc =>
            {
                ...
                var tests = new TestDataFactory(owin, TestData);
                tests.CreateIssuers();
