...
namespace Bhbk.Test.Identity.End2End.Services.Sts
{
    public class ResourceOwnerServiceTests : IClassFixture<BaseStsServiceTests>
    {
        private readonly BaseStsServiceTests _factory;

        public ResourceOwnerServiceTests(BaseStsServiceTests factory) => _factory = factory;
        ...
        public async Task Sts_OAuth2_ResourceOwnerV1_Auth_Fail_Client()
        {
            ...
            using (var scope = _factory.Server.Host.Services.CreateScope())
            {
                ...
                using var seed = ScenarioMother.CreateFromTestSettings(uow, _factory.TestData);
                ...
                var result = await service.Endpoints.ResourceOwner_AuthV1(
                    new ResourceOwnerV1()
                    {
                        ...
                        password = seed.UserPasswords[user.UserName],
                    });
