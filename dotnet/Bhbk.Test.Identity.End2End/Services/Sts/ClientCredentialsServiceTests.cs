...
{
    public class ClientCredentialsServiceTests : IClassFixture<BaseStsServiceTests>
    {
        private readonly BaseStsServiceTests _factory;

        public ClientCredentialsServiceTests(BaseStsServiceTests factory) => _factory = factory;
