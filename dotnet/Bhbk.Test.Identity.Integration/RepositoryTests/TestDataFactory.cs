...
namespace Bhbk.Test.Identity.Integration.RepositoryTests
{
    public class TestDataFactory : IDisposable
    {
        ...
        public void CreateAudiences()
        {
            ...
            {
                foundAudience = _uow.Audiences.Post(
        ...
        public void CreateIssuers()
        {
            ...
            if (foundIssuer == null)
            {
                ...
                foundIssuer = _uow.Issuers.Post(issuerEntity);
        ...
        public void CreateLoginProviders()
        {
            ...
            {
                foundLoginProvider = _uow.LoginProviders.Post(
        ...
        public void CreateSettings()
        {
            ...
            {
                foundGlobalLegacyClaims = _uow.Settings.Post(
                    _map.Map<tbl_Setting>(new SettingV1()
                    {
            ...
            {
                foundGlobalLegacyIssuer = _uow.Settings.Post(
                    _map.Map<tbl_Setting>(new SettingV1()
                    {
            ...
            {
                foundGlobalTotpExpire = _uow.Settings.Post(
                    _map.Map<tbl_Setting>(new SettingV1()
                    {
        ...
        public void CreateUrls()
        {
            ...
            {
                foundAudienceUrl = _uow.Urls.Post(
        ...
        public void Destroy()
        {
            ...
            {
                /* shared in-memory DB; another test class may have already deleted these entities */
            }
        }
