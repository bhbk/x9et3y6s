...
{
    public class AudienceRemoveRoleCommand : ConsoleCommand
    {
        private readonly IConfiguration _conf;
        private readonly IMapper _map;
        private readonly IAdminService _service;
        private readonly IUnitOfWork _uow;
        private tbl_Audience _audience;
        private tbl_Role _role;

        public AudienceRemoveRoleCommand()
        {
            ...
            HasRequiredOption("a|audience=", "Enter existing audience", arg =>
            {
                ...
                _audience = _uow.Audiences.Get(QueryExpressionFactory.GetQueryExpression<tbl_Audience>()
        ...
        public override int Run(string[] remainingArguments)
        {
            try
            {
                _ = _service.Audience_RemoveFromRoleV1(_audience.Id, _role.Id)
                    .Result;
