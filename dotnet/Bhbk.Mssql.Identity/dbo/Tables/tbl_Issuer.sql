CREATE TABLE [dbo].[tbl_Issuer] (
    ...
    [VersionStart] DATETIME2 (7) GENERATED ALWAYS AS ROW START HIDDEN CONSTRAINT [DF_tbl_Issuer_VersionStart] DEFAULT (GETUTCDATE()) NOT NULL,
    [VersionEnd]   DATETIME2 (7) GENERATED ALWAYS AS ROW END HIDDEN   CONSTRAINT [DF_tbl_Issuer_VersionEnd] DEFAULT (CONVERT([datetimeoffset],'9999-12-31 23:59:59.9999999')) NOT NULL,
