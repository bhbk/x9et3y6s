CREATE TABLE [history].[tbl_AudienceEntitlement] (
...
GO
CREATE CLUSTERED INDEX [ix_tbl_AudienceEntitlement]
    ON [history].[tbl_AudienceEntitlement]([VersionEnd] ASC, [VersionStart] ASC) WITH (DATA_COMPRESSION = PAGE);
