...
dotnet test Bhbk.Lib.Identity.Domain.Tests\Bhbk.Lib.Identity.Domain.Tests.csproj --configuration Release /p:CollectCoverage=true /p:CoverletOutput=bin\Release\
...
dotnet pack Bhbk.Lib.Identity\Bhbk.Lib.Identity.csproj -p:PackageVersion=%VERSION% --output . --configuration Release -p:TargetFrameworks=netstandard2.1
dotnet publish Bhbk.Cli.Identity\Bhbk.Cli.Identity.csproj --output bin\Release\netcoreapp3.0\publish --configuration Release --framework netcoreapp3.0
dotnet publish Bhbk.WebApi.Alert\Bhbk.WebApi.Alert.csproj --output bin\Release\netcoreapp3.0\publish --configuration Release --framework netcoreapp3.0
