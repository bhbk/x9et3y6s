...
namespace Bhbk.Lib.Identity.Providers
{
    ...
    {
        public StsClient(IConfigurationRoot conf, InstanceContext situation, HttpClient client)
    ...
    public class StsEndpoints
    {
        ...
        public StsEndpoints(IConfigurationRoot conf, InstanceContext situation, HttpClient client)
        {
            if (conf == null)
