...
namespace Bhbk.Lib.Identity.Helpers
{
    public class JwtHelper : IJwtHelper
    {
        ...
        public JwtHelper(IConfigurationRoot conf, InstanceContext instance, HttpClient client)
        {
        ...
        public JwtSecurityToken ResourceOwnerV1
        {
            get
            {
        ...
        public JwtSecurityToken ResourceOwnerV2
        {
            get
            {
                //check if access is valid...
        ...
        public JwtSecurityToken ClientCredentialV1 => throw new NotImplementedException();

        public JwtSecurityToken ClientCredentialV2 => throw new NotImplementedException();
    }
}
