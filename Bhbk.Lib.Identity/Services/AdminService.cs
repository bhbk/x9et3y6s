...
namespace Bhbk.Lib.Identity.Services
{
    public class AdminService : IAdminService
    {
        ...
        public AdminService(IConfigurationRoot conf, InstanceContext instance, HttpClient client)
        {
            ...
            Endpoints = new AdminRepository(conf, instance, client);
        }
        ...
        {
            var response = Endpoints.Activity_GetV1(_jwt.JwtV2.RawData, model).Result;
        ...
        {
            var response = Endpoints.Claim_CreateV1(_jwt.JwtV2.RawData, model).Result;
        ...
        {
            var response = Endpoints.Claim_DeleteV1(_jwt.JwtV2.RawData, claimID).Result;
        ...
        {
            var response = Endpoints.Claim_GetV1(_jwt.JwtV2.RawData, model).Result;
        ...
        {
            var response = Endpoints.Claim_GetV1(_jwt.JwtV2.RawData, claimValue).Result;
        ...
        {
            var response = Endpoints.Claim_UpdateV1(_jwt.JwtV2.RawData, model).Result;
        ...
        {
            var response = Endpoints.Client_CreateV1(_jwt.JwtV2.RawData, model).Result;
        ...
        {
            var response = Endpoints.Client_DeleteV1(_jwt.JwtV2.RawData, clientID).Result;
        ...
        {
            var response = Endpoints.Client_DeleteRefreshesV1(_jwt.JwtV2.RawData, clientID).Result;
        ...
        {
            var response = Endpoints.Client_DeleteRefreshV1(_jwt.JwtV2.RawData, clientID, refreshID).Result;
        ...
        {
            var response = Endpoints.Client_GetV1(_jwt.JwtV2.RawData, model).Result;
        ...
        {
            var response = Endpoints.Client_GetV1(_jwt.JwtV2.RawData, clientValue).Result;
        ...
        {
            var response = Endpoints.Client_GetRefreshesV1(_jwt.JwtV2.RawData, clientValue).Result;
        ...
        {
            var response = Endpoints.Client_UpdateV1(_jwt.JwtV2.RawData, model).Result;
        ...
        {
            var response = Endpoints.Issuer_CreateV1(_jwt.JwtV2.RawData, model).Result;
        ...
        {
            var response = Endpoints.Issuer_DeleteV1(_jwt.JwtV2.RawData, issuerID).Result;
        ...
        {
            var response = Endpoints.Issuer_GetClientsV1(_jwt.JwtV2.RawData, issuerValue).Result;
        ...
        {
            var response = Endpoints.Issuer_GetV1(_jwt.JwtV2.RawData, model).Result;
        ...
        {
            var response = Endpoints.Issuer_GetV1(_jwt.JwtV2.RawData, issuerValue).Result;
        ...
        {
            var response = Endpoints.Issuer_UpdateV1(_jwt.JwtV2.RawData, model).Result;
        ...
        {
            var response = Endpoints.Login_CreateV1(_jwt.JwtV2.RawData, model).Result;
        ...
        {
            var response = Endpoints.Login_DeleteV1(_jwt.JwtV2.RawData, loginID).Result;
        ...
        {
            var response = Endpoints.Login_GetV1(_jwt.JwtV2.RawData, model).Result;
        ...
        {
            var response = Endpoints.Login_GetV1(_jwt.JwtV2.RawData, loginValue).Result;
        ...
        {
            var response = Endpoints.Login_UpdateV1(_jwt.JwtV2.RawData, model).Result;
        ...
        {
            var response = Endpoints.Role_AddUserV1(_jwt.JwtV2.RawData, roleID, userID).Result;
        ...
        {
            var response = Endpoints.Role_CreateV1(_jwt.JwtV2.RawData, model).Result;
        ...
        {
            var response = Endpoints.Role_DeleteV1(_jwt.JwtV2.RawData, roleID).Result;
        ...
        {
            var response = Endpoints.Role_GetV1(_jwt.JwtV2.RawData, model).Result;
        ...
        {
            var response = Endpoints.Role_GetV1(_jwt.JwtV2.RawData, roleValue).Result;
        ...
        {
            var response = Endpoints.Role_RemoveUserV1(_jwt.JwtV2.RawData, roleID, userID).Result;
        ...
        {
            var response = Endpoints.Role_UpdateV1(_jwt.JwtV2.RawData, model).Result;
        ...
        {
            var response = Endpoints.User_AddLoginV1(_jwt.JwtV2.RawData, userID, loginID).Result;
        ...
        {
            var response = Endpoints.User_AddPasswordV1(_jwt.JwtV2.RawData, userID, model).Result;
        ...
        {
            var response = Endpoints.User_CreateV1(_jwt.JwtV2.RawData, model).Result;
        ...
        {
            var response = Endpoints.User_CreateV1NoConfirm(_jwt.JwtV2.RawData, model).Result;
        ...
        {
            var response = Endpoints.User_DeleteV1(_jwt.JwtV2.RawData, userID).Result;
        ...
        {
            var response = Endpoints.User_DeleteRefreshesV1(_jwt.JwtV2.RawData, userID).Result;
        ...
        {
            var response = Endpoints.User_DeleteRefreshV1(_jwt.JwtV2.RawData, userID, refreshID).Result;
        ...
        {
            var response = Endpoints.User_GetClaimsV1(_jwt.JwtV2.RawData, userValue).Result;
        ...
        {
            var response = Endpoints.User_GetClientsV1(_jwt.JwtV2.RawData, userValue).Result;
        ...
        {
            var response = Endpoints.User_GetLoginsV1(_jwt.JwtV2.RawData, userValue).Result;
        ...
        {
            var response = Endpoints.User_GetRefreshesV1(_jwt.JwtV2.RawData, userValue).Result;
        ...
        {
            var response = Endpoints.User_GetRolesV1(_jwt.JwtV2.RawData, userValue).Result;
        ...
        {
            var response = Endpoints.User_GetV1(_jwt.JwtV2.RawData, model).Result;
        ...
        {
            var response = Endpoints.User_GetV1(_jwt.JwtV2.RawData, userValue).Result;
        ...
        {
            var response = Endpoints.User_RemoveLoginV1(_jwt.JwtV2.RawData, roleID, userID).Result;
        ...
        {
            var response = Endpoints.User_RemovePasswordV1(_jwt.JwtV2.RawData, userID).Result;
        ...
        {
            var response = Endpoints.User_SetPasswordV1(_jwt.JwtV2.RawData, userID, model).Result;
        ...
        {
            var response = Endpoints.User_UpdateV1(_jwt.JwtV2.RawData, model).Result;
