...
namespace Bhbk.Lib.Identity.Services
{
    public class AlertService : IAlertService
    {
        ...
        public AlertService(IConfigurationRoot conf, InstanceContext instance, HttpClient client)
        {
            ...
            Endpoints = new AlertRepository(conf, instance, client);
        }
        ...
        {
            var response = Endpoints.Enqueue_EmailV1(_jwt.JwtV2.RawData, model).Result;
        ...
        {
            var response = Endpoints.Enqueue_TextV1(_jwt.JwtV2.RawData, model).Result;
