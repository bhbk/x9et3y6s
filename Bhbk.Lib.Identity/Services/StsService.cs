...
namespace Bhbk.Lib.Identity.Services
{
    public class StsService : IStsService
    {
        ...
        public StsService(IConfigurationRoot conf, InstanceContext instance, HttpClient client)
        {
            ...
            HttpClient = new StsRepository(conf, instance, client);
        }
        ...
        public StsRepository HttpClient { get; }

        public AuthCodeV1 AuthCode_AskV1(AuthCodeAskV1 model)
        {
            var response = HttpClient.AuthCode_AskV1(model).Result;
        ...
        {
            var response = HttpClient.AuthCode_AskV2(model).Result;
        ...
        {
            var response = HttpClient.AuthCode_UseV1(model).Result;
        ...
        {
            var response = HttpClient.AuthCode_UseV2(model).Result;
        ...
        {
            var response = HttpClient.ClientCredential_UseV1(model).Result;
        ...
        {
            var response = HttpClient.ClientCredential_UseV2(model).Result;
        ...
        {
            var response = HttpClient.ClientCredentialRefresh_UseV1(model).Result;
        ...
        {
            var response = HttpClient.ClientCredentialRefresh_UseV2(model).Result;
        ...
        {
            var response = HttpClient.DeviceCode_AskV1(model).Result;
        ...
        {
            var response = HttpClient.DeviceCode_AskV2(model).Result;
        ...
        {
            var response = HttpClient.DeviceCode_UseV1(model).Result;
        ...
        {
            var response = HttpClient.DeviceCode_UseV2(model).Result;
        ...
        {
            var response = HttpClient.Implicit_UseV1(model).Result;
        ...
        {
            var response = HttpClient.Implicit_UseV2(model).Result;
        ...
        {
            var response = HttpClient.ResourceOwner_UseV1Legacy(model).Result;
        ...
        {
            var response = HttpClient.ResourceOwner_UseV1(model).Result;
        ...
        {
            var response = HttpClient.ResourceOwner_UseV2(model).Result;
        ...
        {
            var response = HttpClient.ResourceOwnerRefresh_UseV1(model).Result;
        ...
        {
            var response = HttpClient.ResourceOwnerRefresh_UseV2(model).Result;
