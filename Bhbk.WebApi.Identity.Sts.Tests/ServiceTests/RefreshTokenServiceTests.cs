...
namespace Bhbk.WebApi.Identity.Sts.Tests.ServiceTests
{
    ...
    public class RefreshTokenServiceTests
    {
        ...
        public async Task Sts_OAuth2_RefreshV1_GetList_Success()
        {
            ...
            var rt = await _service.Repo.RefreshToken_GetListV1((string)ok["access_token"], user.Id.ToString());
        ...
        public async Task Sts_OAuth2_RefreshV1_Revoke_Fail()
        {
            ...
            var rt = await _service.Repo.RefreshToken_DeleteV1((string)ok["access_token"], Guid.NewGuid().ToString(), Guid.NewGuid().ToString());
            rt.Should().BeAssignableTo(typeof(HttpResponseMessage));
            ...
            rt = await _service.Repo.RefreshToken_DeleteAllV1((string)ok["access_token"], Guid.NewGuid().ToString());
            rt.Should().BeAssignableTo(typeof(HttpResponseMessage));
            rt.StatusCode.Should().Be(HttpStatusCode.NotFound);

            rt = await _service.Repo.RefreshToken_DeleteV1((string)ok["access_token"], user.Id.ToString(), Guid.NewGuid().ToString());
            rt.Should().BeAssignableTo(typeof(HttpResponseMessage));
            rt.StatusCode.Should().Be(HttpStatusCode.NotFound);
        }
        ...
        public async Task Sts_OAuth2_RefreshV1_Revoke_Success()
        {
            ...
            var rt = await _service.Repo.RefreshToken_DeleteAllV1((string)ok["access_token"], user.Id.ToString());
            rt.Should().BeAssignableTo(typeof(HttpResponseMessage));
            ...
            rt = await _service.Repo.RefreshToken_DeleteAllV1((string)ok["access_token"], user.Id.ToString());
            rt.Should().BeAssignableTo(typeof(HttpResponseMessage));
            rt.StatusCode.Should().Be(HttpStatusCode.NoContent);
        }
        ...
        public async Task Sts_OAuth2_RefreshV1_Use_FailClient()
        {
            ...
            var rt = await _service.Repo.RefreshToken_UseV1(
                new RefreshTokenV1()
                {
                    issuer_id = issuer.Id.ToString(),
            ...
            rt = await _service.Repo.RefreshToken_UseV1(
                new RefreshTokenV1()
                {
                    issuer_id = issuer.Id.ToString(),
        ...
        public async Task Sts_OAuth2_RefreshV1_Use_Success_ClientSingle()
        {
            ...
            JwtHelper.CanReadToken(check.access_token).Should().BeTrue();

            var claims = JwtHelper.ReadJwtToken(check.access_token).Claims
        ...
        public async Task Sts_OAuth2_RefreshV2_GetList_Success()
        {
            ...
            var rt = await _service.Repo.RefreshToken_GetListV2((string)ok["access_token"], user.Id.ToString());
            rt.Should().BeAssignableTo(typeof(HttpResponseMessage));
            rt.StatusCode.Should().Be(HttpStatusCode.OK);
        ...
        public async Task Sts_OAuth2_RefreshV2_Revoke_Fail()
        {
            ...
            var rt = await _service.Repo.RefreshToken_DeleteAllV2((string)ok["access_token"], Guid.NewGuid().ToString());
            rt.Should().BeAssignableTo(typeof(HttpResponseMessage));
            rt.StatusCode.Should().Be(HttpStatusCode.Unauthorized);
            ...
            rt = await _service.Repo.RefreshToken_DeleteAllV2((string)ok["access_token"], Guid.NewGuid().ToString());
            rt.Should().BeAssignableTo(typeof(HttpResponseMessage));
            rt.StatusCode.Should().Be(HttpStatusCode.NotFound);

            rt = await _service.Repo.RefreshToken_DeleteV2((string)ok["access_token"], user.Id.ToString(), Guid.NewGuid().ToString());
            rt.Should().BeAssignableTo(typeof(HttpResponseMessage));
            rt.StatusCode.Should().Be(HttpStatusCode.NotFound);
        }
        ...
        public async Task Sts_OAuth2_RefreshV2_Revoke_Success()
        {
            ...
            var rt = await _service.Repo.RefreshToken_DeleteAllV2((string)ok["access_token"], user.Id.ToString());
            rt.Should().BeAssignableTo(typeof(HttpResponseMessage));
            rt.StatusCode.Should().Be(HttpStatusCode.NoContent);
            ...
            rt = await _service.Repo.RefreshToken_DeleteV2((string)ok["access_token"], user.Id.ToString(), refresh.Id.ToString());
            rt.Should().BeAssignableTo(typeof(HttpResponseMessage));
            rt.StatusCode.Should().Be(HttpStatusCode.NoContent);
        }
        ...
        public async Task Sts_OAuth2_RefreshV2_Use_FailClient()
        {
            ...
            var rop_rt = await _service.Repo.RefreshToken_UseV2(
                new RefreshTokenV2()
                {
                    issuer = issuer.Id.ToString(),
            ...
            var cc_rt = await _service.Repo.RefreshToken_UseV2(
                new RefreshTokenV2()
                {
                    issuer = issuer.Id.ToString(),
                    client = string.Join(",", new List<string> { Guid.NewGuid().ToString() }),
            ...
            rop_rt = await _service.Repo.RefreshToken_UseV2(
                new RefreshTokenV2()
                {
                    issuer = issuer.Id.ToString(),
                    client = string.Join(",", new List<string> { client.Id.ToString() }),
            ...
            cc_rt = await _service.Repo.RefreshToken_UseV2(
                new RefreshTokenV2()
                {
                    issuer = issuer.Id.ToString(),
                    client = string.Join(",", new List<string> { client.Id.ToString() }),
        ...
        public async Task Sts_OAuth2_RefreshV2_Use_FailUser()
        {
            ...
            var rt = await _service.Repo.RefreshToken_UseV2(
                new RefreshTokenV2()
                {
                    issuer = issuer.Id.ToString(),
                    client = string.Join(",", new List<string> { client.Id.ToString() }),
            ...
            rt = await _service.Repo.RefreshToken_UseV2(
                new RefreshTokenV2()
                {
                    issuer = issuer.Id.ToString(),
                    client = string.Join(",", new List<string> { client.Id.ToString() }),
        ...
        public async Task Sts_OAuth2_RefreshV2_Use_Success_ClientSingle()
        {
            ...
            JwtHelper.CanReadToken(rt_check.access_token).Should().BeTrue();

            var rt_claims = JwtHelper.ReadJwtToken(rt_check.access_token).Claims
                .Where(x => x.Type == JwtRegisteredClaimNames.Iss).SingleOrDefault();
            ...
            JwtHelper.CanReadToken(cc_check.access_token).Should().BeTrue();

            var cc_claims = JwtHelper.ReadJwtToken(cc_check.access_token).Claims
                .Where(x => x.Type == JwtRegisteredClaimNames.Iss).SingleOrDefault();
