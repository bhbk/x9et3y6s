...
namespace Bhbk.WebApi.Identity.Sts.Tests.ServiceTests
{
    ...
    public class ClientCredentialsServiceTests
    {
        ...
        {
            var rt = await _service.Repo.ClientCredentialRefresh_UseV1(
                new RefreshTokenV1()
                {
        ...
        public async Task Sts_OAuth2_ClientCredentialV2_Refresh_FailClient()
        {
            ...
            var rt = await _service.Repo.ClientCredentialRefresh_UseV2(
                new RefreshTokenV2()
                {
                    issuer = issuer.Id.ToString(),
            ...
            rt = await _service.Repo.ClientCredentialRefresh_UseV2(
                new RefreshTokenV2()
                {
                    issuer = issuer.Id.ToString(),
        ...
        public async Task Sts_OAuth2_ClientCredentialV2_Refresh_FailIssuer()
        {
            ...
            rt = await _service.Repo.ResourceOwnerRefresh_UseV2(
                new RefreshTokenV2()
                {
                    issuer = issuer.Id.ToString(),
                    client = string.Join(",", new List<string> { client.Id.ToString() }),
        ...
        public async Task Sts_OAuth2_ClientCredentialV2_Refresh_FailToken()
        {
            ...
            var rt = await _service.Repo.ResourceOwnerRefresh_UseV2(
                new RefreshTokenV2()
                {
                    issuer = issuer.Id.ToString(),
                    client = string.Join(",", new List<string> { client.Id.ToString() }),
