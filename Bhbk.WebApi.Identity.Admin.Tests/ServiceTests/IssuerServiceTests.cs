...
namespace Bhbk.WebApi.Identity.Admin.Tests.ServiceTests
{
    ...
    public class IssuerServiceTests
    {
        ...
        public async Task Admin_IssuerV1_Create_Fail()
        {
            ...
            var result = await _service.Raw.Issuer_CreateV1(rop.token, new IssuerCreate());
            ...
            result = await _service.Raw.Issuer_CreateV1(rop.token, new IssuerCreate());
        ...
        public async Task Admin_IssuerV1_Create_Success()
        {
            ...
            var result = await _service.Raw.Issuer_CreateV1(rop.token, create);
        ...
        public async Task Admin_IssuerV1_Delete_Fail()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.Issuer_DeleteV1(rop.token, Guid.NewGuid());
            ...
            rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            result = await _service.Raw.Issuer_DeleteV1(rop.token, Guid.NewGuid());
            ...
            result = await _service.Raw.Issuer_DeleteV1(rop.token, model.Id);
        ...
        public async Task Admin_IssuerV1_Delete_Success()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.Issuer_DeleteV1(rop.token, testIssuer.Id);
        ...
        public async Task Admin_IssuerV1_Get_Success()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.Issuer_GetV1(rop.token, testIssuer.Id.ToString());
            ...
            result = await _service.Raw.Issuer_GetV1(rop.token, testIssuer.Name);
        ...
        public async Task Admin_IssuerV1_GetList_Success()
        {
            ...
            var result = await _service.Raw.Issuer_GetV1(rop.token,
                new CascadePager()
                {
                    Filter = string.Empty,
                    Orders = orders,
        ...
        public async Task Admin_IssuerV1_Update_Fail()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.Issuer_UpdateV1(rop.token, new IssuerModel());
            ...
            rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            result = await _service.Raw.Issuer_UpdateV1(rop.token, new IssuerModel());
        ...
        public async Task Admin_IssuerV1_Update_Success()
        {
            ...
            var response = await _service.Raw.Issuer_UpdateV1(rop.token, _factory.UoW.Mapper.Map<IssuerModel>(testIssuer));
