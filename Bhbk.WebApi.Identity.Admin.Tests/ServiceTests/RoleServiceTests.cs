...
namespace Bhbk.WebApi.Identity.Admin.Tests.ServiceTests
{
    ...
    public class RoleServiceTests
    {
        ...
        public async Task Admin_RoleV1_AddToUser_Success()
        {
            ...
            var result = await _service.Raw.Role_AddUserV1(rop.token, testRole.Id, user.Id);
        ...
        public async Task Admin_RoleV1_Create_Fail()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.Role_CreateV1(rop.token, new RoleCreate());
            ...
            result = await _service.Raw.Role_CreateV1(rop.token, new RoleCreate());
        ...
        public async Task Admin_RoleV1_Create_Success()
        {
            ...
            var result = await _service.Raw.Role_CreateV1(rop.token, create);
        ...
        public async Task Admin_RoleV1_Delete_Fail()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.Role_DeleteV1(rop.token, Guid.NewGuid());
            ...
            rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            result = await _service.Raw.Role_DeleteV1(rop.token, Guid.NewGuid());
            ...
            result = await _service.Raw.Role_DeleteV1(rop.token, testRole.Id);
        ...
        public async Task Admin_RoleV1_Delete_Success()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.Role_DeleteV1(rop.token, testRole.Id);
        ...
        public async Task Admin_RoleV1_Get_Success()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.Role_GetV1(rop.token, testRole.Id.ToString());
            ...
            result = await _service.Raw.Role_GetV1(rop.token, testRole.Name);
        ...
        public async Task Admin_RoleV1_GetList_Success()
        {
            ...
            var response = await _service.Raw.Role_GetV1(access.token,
                new CascadePager()
                {
                    Filter = string.Empty,
                    Orders = orders,
        ...
        public async Task Admin_RoleV1_RemoveFromUser_Success()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.Role_RemoveUserV1(rop.token, testRole.Id, testUser.Id);
        ...
        public async Task Admin_RoleV1_Update_Fail()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.Role_UpdateV1(rop.token, new RoleModel());
            ...
            rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            result = await _service.Raw.Role_UpdateV1(rop.token, new RoleModel());
        ...
        public async Task Admin_RoleV1_Update_Success()
        {
            ...
            var result = await _service.Raw.Role_UpdateV1(rop.token, _factory.UoW.Mapper.Map<RoleModel>(testRole));
