...
namespace Bhbk.WebApi.Identity.Admin.Tests.ServiceTests
{
    ...
    public class ClientServiceTests
    {
        ...
        public async Task Admin_ClientV1_Create_Fail()
        {
            ...
            var result = await _service.Raw.Client_CreateV1(rop.token, new ClientCreate());
            ...
            result = await _service.Raw.Client_CreateV1(rop.token, new ClientCreate());
        ...
        public async Task Admin_ClientV1_Create_Success()
        {
            ...
            var result = await _service.Raw.Client_CreateV1(rop.token, create);
        ...
        public async Task Admin_ClientV1_Delete_Fail()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.Client_DeleteV1(rop.token, Guid.NewGuid());
            ...
            rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            result = await _service.Raw.Client_DeleteV1(rop.token, Guid.NewGuid());
            ...
            result = await _service.Raw.Client_DeleteV1(rop.token, client1.Id);
        ...
        public async Task Admin_ClientV1_Delete_Success()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.Client_DeleteV1(rop.token, testClient.Id);
        ...
        public async Task Admin_ClientV1_Get_Success()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.Client_GetV1(rop.token, client.Id.ToString());
            ...
            result = await _service.Raw.Client_GetV1(rop.token, client.Name);
        ...
        public async Task Admin_ClientV1_GetList_Success()
        {
            ...
            var response = await _service.Raw.Client_GetV1(rop.token, model);
        ...
        public async Task Admin_ClientV1_Update_Fail()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.Client_UpdateV1(rop.token, new ClientModel());
            ...
            rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            result = await _service.Raw.Client_UpdateV1(rop.token, new ClientModel());
        ...
        public async Task Admin_ClientV1_Update_Success()
        {
            ...
            var result = await _service.Raw.Client_UpdateV1(rop.token, _factory.UoW.Mapper.Map<ClientModel>(client1));
