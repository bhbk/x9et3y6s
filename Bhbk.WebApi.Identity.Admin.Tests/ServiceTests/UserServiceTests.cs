...
namespace Bhbk.WebApi.Identity.Admin.Tests.ServiceTests
{
    ...
    public class UserServiceTests
    {
        ...
        public async Task Admin_UserV1_AddToLogin_Success()
        {
            ...
            var result = await _service.Raw.User_AddLoginV1(rop.token, testUser.Id, login.Id);
        ...
        public async Task Admin_UserV1_AddPassword_Fail()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.User_AddPasswordV1(rop.token, Guid.NewGuid(), new UserAddPassword());
            ...
            result = await _service.Raw.User_AddPasswordV1(rop.token, Guid.NewGuid(), new UserAddPassword());
        ...
        public async Task Admin_UserV1_AddPassword_Success()
        {
            ...
            var result = await _service.Raw.User_AddPasswordV1(rop.token, testUser.Id,
                new UserAddPassword()
                {
                    UserId = testUser.Id,
        ...
        public async Task Admin_UserV1_Create_Fail()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.User_CreateV1(rop.token, new UserCreate());
            ...
            rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            result = await _service.Raw.User_CreateV1(rop.token, new UserCreate());
        ...
        public async Task Admin_UserV1_Create_Success()
        {
            ...
            var result = await _service.Raw.User_CreateV1NoConfirm(rop.token, create);
            ...
            result = await _service.Raw.User_CreateV1(rop.token, create);
        ...
        public async Task Admin_UserV1_Delete_Fail()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.User_DeleteV1(rop.token, Guid.NewGuid());
            ...
            rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            result = await _service.Raw.User_DeleteV1(rop.token, Guid.NewGuid());
            ...
            result = await _service.Raw.User_DeleteV1(rop.token, user1.Id);
        ...
        public async Task Admin_UserV1_Delete_Success()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.User_DeleteV1(rop.token, testUser.Id);
        ...
        public async Task Admin_UserV1_Get_Success()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.User_GetV1(rop.token, testUser.Id.ToString());
            ...
            result = await _service.Raw.User_GetV1(rop.token, testUser.Email);
        ...
        public async Task Admin_UserV1_GetList_Success()
        {
            ...
            var result = await _service.Raw.User_GetV1(rop.token,
                new CascadePager()
                {
                    Filter = string.Empty,
                    Orders = orders,
        ...
        public async Task Admin_UserV1_GetListClaims_Success()
        {
            ...
            var result = await _service.Raw.User_GetClaimsV1(rop.token, user.Id.ToString());
        ...
        public async Task Admin_UserV1_GetListClients_Success()
        {
            ...
            var result = await _service.Raw.User_GetClientsV1(rop.token, user.Id.ToString());
        ...
        public async Task Admin_UserV1_GetListLogins_Success()
        {
            ...
            var result = await _service.Raw.User_GetLoginsV1(rop.token, user.Id.ToString());
        ...
        public async Task Admin_UserV1_GetListRoles_Success()
        {
            ...
            var result = await _service.Raw.User_GetRolesV1(rop.token, user.Id.ToString());
        ...
        public async Task Admin_UserV1_RemoveFromLogin_Success()
        {
            ...
            var result = await _service.Raw.User_RemoveLoginV1(rop.token, testUser.Id, login.Id);
        ...
        public async Task Admin_UserV1_RemovePassword_Fail()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.User_RemovePasswordV1(rop.token, Guid.NewGuid());
            ...
            rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            result = await _service.Raw.User_RemovePasswordV1(rop.token, Guid.NewGuid());
        ...
        public async Task Admin_UserV1_RemovePassword_Success()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.User_RemovePasswordV1(rop.token, testUser.Id);
        ...
        public async Task Admin_UserV1_SetPassword_Fail()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.User_SetPasswordV1(rop.token, Guid.NewGuid(), new UserAddPassword());
            ...
            rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            result = await _service.Raw.User_SetPasswordV1(rop.token, Guid.NewGuid(), new UserAddPassword());
        ...
        public async Task Admin_UserV1_SetPassword_Success()
        {
            ...
            var result = await _service.Raw.User_SetPasswordV1(rop.token, testUser.Id, model);
        ...
        public async Task Admin_UserV1_Update_Fail()
        {
            ...
            var rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            var result = await _service.Raw.User_UpdateV1(rop.token, new UserModel());
            ...
            rop = await JwtHelper.UserResourceOwnerV2(_factory.UoW, issuer, new List<tbl_Clients> { client }, user);
            result = await _service.Raw.User_UpdateV1(rop.token, new UserModel());
        ...
        public async Task Admin_UserV1_Update_Success()
        {
            ...
            var result = await _service.Raw.User_UpdateV1(rop.token, _factory.UoW.Mapper.Map<UserModel>(testUser));
