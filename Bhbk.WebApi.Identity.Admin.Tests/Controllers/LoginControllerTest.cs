...
namespace Bhbk.WebApi.Identity.Admin.Tests.Controllers
{
    ...
    public class LoginControllerTest
    {
        ...
        public async Task Admin_LoginV1_Create_Fail()
        {
            ...
            access = await JwtBuilder.CreateAccessTokenV2(_factory.UoW, issuer, new List<TClients> { client }, user);
        ...
        public async Task Admin_LoginV1_Get_Success()
        {
            ...
            response = await _endpoints.Login_GetV1(access.token, model.Name);
        ...
        public async Task Admin_LoginV1_Update_Success()
        {
            ...
            var response = await _endpoints.Login_UpdateV1(access.token, _factory.UoW.Transform.Map<LoginModel>(login));
