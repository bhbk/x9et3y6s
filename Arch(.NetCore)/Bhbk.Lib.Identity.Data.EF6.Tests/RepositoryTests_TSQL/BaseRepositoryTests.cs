...
using Bhbk.Lib.Identity.Data.EF6.Infrastructure_TSQL;
using Bhbk.Lib.Identity.Data.EF6.Tests.TestingTools;
...
{
    [CollectionDefinition("RepositoryTests_TSQL")]
    ...
    public class BaseRepositoryTests
    {
        ...
        public BaseRepositoryTests()
        {
            ...
            Mapper = new MapperConfiguration(x => x.AddProfile<AutoMapperProfile_EF6_TSQL>()).CreateMapper();

            UoW = new UnitOfWork(conf["Databases:IdentityEntities_TSQL"],
