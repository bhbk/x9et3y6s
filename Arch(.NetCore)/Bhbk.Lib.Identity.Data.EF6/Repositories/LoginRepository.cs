...
namespace Bhbk.Lib.Identity.Data.EF6.Repositories
{
    public class LoginRepository : GenericRepository<uvw_Login>
    {
        ...
        public override uvw_Login Create(uvw_Login entity)
        {
            ...
            return _context.Database.SqlQuery<uvw_Login>("[svc].[usp_Login_Insert]"
        ...
        public override uvw_Login Delete(uvw_Login entity)
        {
            ...
            return _context.Database.SqlQuery<uvw_Login>("[svc].[usp_Login_Delete] @Id", pvalues.ToArray())
                .AsEnumerable().Single();
        }
        ...
        public override uvw_Login Update(uvw_Login entity)
        {
            ...
            return _context.Database.SqlQuery<uvw_Login>("[svc].[usp_Login_Update]"
