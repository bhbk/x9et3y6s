...
namespace Bhbk.Lib.Identity.Data.EF6.Models_TSQL
{
    ...
    public partial class IdentityEntities_TSQL : DbContext
    {
        public IdentityEntities_TSQL()
            : base("name=IdentityEntities_TSQL")
        {
        }
        ...
        public virtual ObjectResult<usp_EmailQueue_Insert_Result> usp_EmailQueue_Insert(Nullable<System.Guid> fromId, string fromEmail, string fromDisplay, Nullable<System.Guid> toId, string toEmail, string toDisplay, string subject, string body, Nullable<System.DateTimeOffset> sendAtUtc)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_EmailQueue_Insert_Result>("usp_EmailQueue_Insert", fromIdParameter, fromEmailParameter, fromDisplayParameter, toIdParameter, toEmailParameter, toDisplayParameter, subjectParameter, bodyParameter, sendAtUtcParameter);
        }
    
        public virtual ObjectResult<usp_EmailQueue_Update_Result> usp_EmailQueue_Update(Nullable<System.Guid> id, Nullable<System.Guid> fromId, string fromEmail, string fromDisplay, Nullable<System.Guid> toId, string toEmail, string toDisplay, string subject, string body, Nullable<System.DateTimeOffset> sendAtUtc)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(System.Guid));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_EmailQueue_Update_Result>("usp_EmailQueue_Update", idParameter, fromIdParameter, fromEmailParameter, fromDisplayParameter, toIdParameter, toEmailParameter, toDisplayParameter, subjectParameter, bodyParameter, sendAtUtcParameter);
        }
        ...
        public virtual ObjectResult<usp_TextQueue_Insert_Result> usp_TextQueue_Insert(Nullable<System.Guid> fromId, string fromPhoneNumber, Nullable<System.Guid> toId, string toPhoneNumber, string body, Nullable<System.DateTimeOffset> sendAtUtc)
        {
            var fromIdParameter = fromId.HasValue ?
                new ObjectParameter("FromId", fromId) :
                new ObjectParameter("FromId", typeof(System.Guid));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_TextQueue_Insert_Result>("usp_TextQueue_Insert", fromIdParameter, fromPhoneNumberParameter, toIdParameter, toPhoneNumberParameter, bodyParameter, sendAtUtcParameter);
        }
    
        public virtual ObjectResult<usp_TextQueue_Update_Result> usp_TextQueue_Update(Nullable<System.Guid> id, Nullable<System.Guid> fromId, string fromPhoneNumber, Nullable<System.Guid> toId, string toPhoneNumber, string body, Nullable<System.DateTimeOffset> sendAtUtc)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(System.Guid));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_TextQueue_Update_Result>("usp_TextQueue_Update", idParameter, fromIdParameter, fromPhoneNumberParameter, toIdParameter, toPhoneNumberParameter, bodyParameter, sendAtUtcParameter);
        }
