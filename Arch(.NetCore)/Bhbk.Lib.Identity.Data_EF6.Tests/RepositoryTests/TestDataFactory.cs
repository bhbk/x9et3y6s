...
namespace Bhbk.Lib.Identity.Data_EF6.Tests.RepositoryTests
{
    public class TestDataFactory : IDisposable
    {
        ...
        private E_Claim foundClaim;
        private E_Role foundRole;
        private E_User foundUser;
        ...
        public void CreateClaims()
        {
            ...
            foundClaim = _uow.Claims.Get(QueryExpressionFactory.GetQueryExpression<E_Claim>()
        ...
        public void CreateUsers()
        {
            ...
            foundUser = _uow.Users.Get(QueryExpressionFactory.GetQueryExpression<E_User>()
