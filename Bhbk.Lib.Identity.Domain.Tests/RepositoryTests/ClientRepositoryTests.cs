...
namespace Bhbk.Lib.Identity.Domain.Tests.RepositoryTests
{
    ...
    public class ClientRepositoryTests : BaseRepositoryTests
    {
        ...
        public async Task Repo_Clients_CreateV1_Fail()
        {
        ...
        [Fact]
        public async Task Repo_Clients_CreateV1_Success()
        {
        ...
        [Fact]
        public async Task Repo_Clients_DeleteV1_Fail()
        {
        ...
        [Fact]
        public async Task Repo_Clients_DeleteV1_Success()
        {
            new TestData(UoW, Mapper).DestroyAsync().Wait();
            new TestData(UoW, Mapper).CreateAsync().Wait();
        ...
        [Fact]
        public async Task Repo_Clients_GetV1_Success()
        {
            new TestData(UoW, Mapper).DestroyAsync().Wait();
            new TestData(UoW, Mapper).CreateAsync().Wait();
        ...
        [Fact]
        public async Task Repo_Clients_UpdateV1_Fail()
        {
        ...
        [Fact]
        public async Task Repo_Clients_UpdateV1_Success()
        {
            new TestData(UoW, Mapper).DestroyAsync().Wait();
            new TestData(UoW, Mapper).CreateAsync().Wait();
