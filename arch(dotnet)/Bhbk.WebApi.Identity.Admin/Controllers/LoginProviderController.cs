...
namespace Bhbk.WebApi.Identity.Admin.Controllers
{
    ...
    public class LoginProviderController : BaseController
    {
        ...
        public IActionResult CreateV1([FromBody] LoginProviderV1 model)
        {
            ...
            var result = uow.LoginProviders.Create(map.Map<tbl_LoginProvider>(model));
        ...
        public IActionResult GetV1([FromBody] DataStateV1 state)
        {
            ...
            try
            {
                var result = new DataStateV1Result<LoginProviderV1>
                {
        ...
        public IActionResult UpdateV1([FromBody] LoginProviderV1 model)
        {
            ...
            var result = uow.LoginProviders.Update(map.Map<tbl_LoginProvider>(model));
