    ...
    public class UserServiceTests : IClassFixture<BaseServiceTests>
    {
            ...
            using (var scope = _factory.Server.Host.Services.CreateScope())
            {
                ...
                var testClaim = uow.Claims.Create(
                    map.Map<tbl_Claim>(new ClaimV1()
                    {
                        ...
                        Type = Base64.CreateString(4) + "-" + _factory.TestData.Claim.Name,
        ...
        public async Task Admin_UserV1_Create_Success()
        {
            ...
            using (var scope = _factory.Server.Host.Services.CreateScope())
            {
                ...
                var address = Base64.CreateString(4) + "-" + _factory.TestData.User.UserName;
        ...
        public async Task Admin_UserV1_Update_Success()
        {
            ...
            using (var scope = _factory.Server.Host.Services.CreateScope())
            {
                ...
                var testUser = uow.Users.GetAsNoTracking(x => x.UserName == _factory.TestData.User.UserName).Single();
