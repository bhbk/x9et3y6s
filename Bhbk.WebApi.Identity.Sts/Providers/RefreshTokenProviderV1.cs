...
{
    public static class ExtendRefreshTokenProviderV1
    {
        public static IApplicationBuilder UseRefreshTokenProviderV1(this IApplicationBuilder app)
        {
            return app.UseMiddleware<RefreshTokenProviderV1>();
        }
    }
