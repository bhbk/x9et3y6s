CREATE TABLE [dbo].[tbl_Clients] (
    ...
    [AccessFailedCount]  INT                CONSTRAINT [DF_tbl_Clients_AccessFailedCount] DEFAULT ((0)) NULL,
    [AccessSuccessCount] INT                CONSTRAINT [DF_tbl_Clients_AccessSuccessCount] DEFAULT ((0)) NULL,
